...
find /data/hpfx.collab.science.gc.ca/*/WXO-DD/model_ciops/east/ -type f | grep -E "(Sfc|0.5m)" > ciops-east-2d-archive.txt
...
find /data/hpfx.collab.science.gc.ca/*/WXO-DD/model_ciops/east -type f -name "*-all_*.nc" > ciops-east-3d-archive.txt
...
find /data/hpfx.collab.science.gc.ca/*/WXO-DD/model_ciops/west/ -type f | grep -E "(Sfc|0.5m)" > ciops-west-2d-archive.txt
...
find /data/hpfx.collab.science.gc.ca/*/WXO-DD/model_ciops/west/ -type f -name "*-all_*.nc" > ciops-west-3d-archive.txt
...
find /data/hpfx.collab.science.gc.ca/*/WXO-DD/model_ciops/salish-sea/ -type f | grep -E "(Sfc|0.5m)" > ciops-salish-2d-archive.txt
...
find /data/hpfx.collab.science.gc.ca/*/WXO-DD/model_ciops/salish-sea/ -type f -name "*-all_*.nc" > ciops-salish-3d-archive.txt
