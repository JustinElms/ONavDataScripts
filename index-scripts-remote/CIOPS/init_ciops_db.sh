...
while [ $DATE -le $ENDDATE ]; do 
    ...
    find /data/hpfx.collab.science.gc.ca/${DATE}*/WXO-DD/model_ciops/east/ -type f | grep -E "(Sfc|0.5m)" > ${HOME}/db/ciops-east-2d-archive.txt
    ...
    find /data/hpfx.collab.science.gc.ca/${DATE}*/WXO-DD/model_ciops/west/ -type f | grep -E "(Sfc|0.5m)" > ${HOME}/db/ciops-west-2d-archive.txt
    ...
    find /data/hpfx.collab.science.gc.ca/${DATE}*/WXO-DD/model_ciops/salish-sea/ -type f | grep -E "(Sfc|0.5m)" > ${HOME}/db/ciops-salish-2d-archive.txt
