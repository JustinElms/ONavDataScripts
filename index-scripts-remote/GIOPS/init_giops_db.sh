...
find /data/hpfx.collab.science.gc.ca/*/WXO-DD/model_giops/netcdf/lat_lon/3d/00/024/ -type f > ${HOME}/db/giops-fc3dll-10day-00-archive.txt
...
find /data/hpfx.collab.science.gc.ca/*/WXO-DD/model_giops/netcdf/lat_lon/3d/12/024/ -type f > ${HOME}/db/giops-fc3dll-10day-12-archive.txt
