...
[ -f ${HOME}/netcdf-timestamp-mapper/giops-fc2dll.txt ] && rm ${HOME}/netcdf-timestamp-mapper/giops-fc2dll.txt
...
find /data/hpfx.collab.science.gc.ca/${DATE}/WXO-DD/model_giops/netcdf/lat_lon/2d/ -type f > giops-fc2dll.txt
${HOME}/netcdf-timestamp-mapper/build/nc-timestamp-mapper -n giops-fc2dll -i /data/hpfx.collab.science.gc.ca/${DATE}/WXO-DD/model_giops/ -o ${HOME}/db --file-list giops-fc2dll.txt -h
