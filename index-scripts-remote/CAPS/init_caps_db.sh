...
find /data/hpfx.collab.science.gc.ca/*/WXO-DD/model_caps/3km/ -type f | grep -E "(Sfc|0.5m)" > ${HOME}/db/caps-fc2drp.txt
...
while [ $DATE -le $ENDDATE ]; do
    find /data/hpfx.collab.science.gc.ca/${DATE}*/WXO-DD/model_caps/3km/ -type f | grep -E "(Sfc|0.5m)" > ${HOME}/db/caps-fc2drp.txt
    ...
    find /data/hpfx.collab.science.gc.ca/${DATE}*/WXO-DD/model_caps/3km/ -type f | grep -E "(-all_)" > ${HOME}/db/caps-fc3drp.txt
