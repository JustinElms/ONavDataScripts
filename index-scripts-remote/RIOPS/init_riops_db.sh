...
while [ $DATE -le $ENDDATE ]; do 
    ...
    find /data/hpfx.collab.science.gc.ca/${DATE}*/WXO-DD/model_riops/netcdf/forecast/polar_stereographic/2d/ -type f > riops-fc2dps-archive.txt
    ...
    find /data/hpfx.collab.science.gc.ca/${DATE}*/WXO-DD/model_riops/netcdf/forecast/polar_stereographic/3d/ -type f > riops-fc3dps-archive.txt
