...
ssh ubuntu@u2204-icechunk "cd icechunk/ ; python ic_interface.add_nc_data.py giops_day -s"
ssh ubuntu@u2204-icechunk "cd icechunk/ ; python ic_interface.add_nc_data.py gdwps_2dll -s"