...
ssh ubuntu@u2204-icechunk "cd icechunk/ ; python ic_interface.add_nc_data.py riops_fc_3dps -s --nc_dir /data/hpfx.collab.science.gc.ca/${DATE}/WXO-DD/model_riops/netcdf/forecast/polar_stereographic/3d/"
ssh ubuntu@u2204-icechunk "cd icechunk/ ; python ic_interface.add_nc_data.py riops_fc_2dps -s --nc_dir /data/hpfx.collab.science.gc.ca/${DATE}/WXO-DD/model_riops/netcdf/forecast/polar_stereographic/2d/"
